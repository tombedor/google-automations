/**
 * Interface for the parameters passed to setCalendars
 */
interface SetCalendarsParams {
  calendar_ids: string[];
}

/**
 * Interface for the result of setCalendars
 */
interface SetCalendarsResult {
  success: boolean;
  message?: string;
  error?: string;
  calendar_ids?: string[];
 ...
 *
 * @param params - Parameters object with calendar_ids array
 * @return Result of the operation
 */
function setCalendars(params: SetCalendarsParams): SetCalendarsResult {
